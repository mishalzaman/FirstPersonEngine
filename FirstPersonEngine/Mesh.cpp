...
Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices, std::vector<Texture> textures, glm::vec3 extents, std::string name, glm::mat4 mTransform, const unsigned int mType)
{
...
//void Mesh::updateColPosition(glm::vec3 direction)
//{ 
//    btScalar matrix[16];
//    btTransform trans;
//
