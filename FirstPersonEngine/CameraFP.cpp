...
void CameraFP::setCameraPosition(glm::vec3 position)
{
...
float CameraFP::getYaw()
{
	return this->yaw;
}

float CameraFP::getPitch()
{
	return this->pitch;
}

glm::vec3 CameraFP::getFrontVector()
{
	return this->frontVector;
}

glm::vec3 CameraFP::getRightVector()
{
