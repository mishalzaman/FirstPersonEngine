#ifndef SYS_SDL_OPENGL
#define SYS_SDL_OPENGL
...
namespace SysSdlOpenGL {
    ...
    int initSDL();
    int defaults(SDL_Window* &window, SDL_GLContext &context, unsigned int screenWidth, unsigned int screenHeight, unsigned int sMinor, unsigned int sMajor);
